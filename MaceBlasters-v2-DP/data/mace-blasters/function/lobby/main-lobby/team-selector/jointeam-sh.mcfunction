...
execute in mace-blasters:mace as @a[tag=team.cloud.leave] run playsound minecraft:block.azalea.hit voice @s 0 217 24 1 1
execute in mace-blasters:mace as @a[tag=team.cloud.leave] run particle minecraft:angry_villager 0 217 24 1 2 1 1 3 force
...
# cambiar sonido y efecto, placeholders!
execute in mace-blasters:mace as @a[tag=team.cloud.join] run playsound minecraft:block.azalea.hit voice @s 0 217 24 1 1
execute in mace-blasters:mace as @a[tag=team.cloud.join] run particle minecraft:angry_villager 0 217 24 1 2 1 1 3 force
...
# cambiar sonido y efecto, placeholders!
execute in mace-blasters:mace as @a[tag=betray.team.cloud.join] run playsound minecraft:block.azalea.hit voice @s 0 217 24 1 1
execute in mace-blasters:mace as @a[tag=betray.team.cloud.join] run particle minecraft:angry_villager 0 217 24 1 2 1 1 3 force
...
# cambiar sonido y efecto, placeholders!
execute in mace-blasters:mace as @a[tag=team.spark.leave] run playsound minecraft:block.azalea.hit voice @s 0 217 24 1 1
execute in mace-blasters:mace as @a[tag=team.spark.leave] run particle minecraft:angry_villager 0 217 24 1 2 1 1 3 force
...
# cambiar sonido y efecto, placeholders!
execute in mace-blasters:mace as @a[tag=team.spark.join] run playsound minecraft:block.azalea.hit voice @s 0 217 24 1 1
execute in mace-blasters:mace as @a[tag=team.spark.join] run particle minecraft:angry_villager 0 217 24 1 2 1 1 3 force
...
# cambiar sonido y efecto, placeholders!
execute in mace-blasters:mace as @a[tag=betray.team.spark.join] run playsound minecraft:block.azalea.hit voice @s 0 217 24 1 1
execute in mace-blasters:mace as @a[tag=betray.team.spark.join] run particle minecraft:angry_villager 0 217 24 1 2 1 1 3 force
