...
execute in mace-blasters:mace as @a[x=9,dx=2,y=216,dy=1,z=32,dz=2,team=!team.spark,team=!team.spectate,team=team.cloud,tag=team.cloud] run tellraw @s {"text":"messaje.leave_cloud"}
execute in mace-blasters:mace as @a[x=9,dx=2,y=216,dy=1,z=32,dz=2,team=!team.spark,team=!team.spectate,team=team.cloud,tag=team.cloud] run team leave @s
