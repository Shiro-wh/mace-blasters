...
execute as @e[type=minecraft:interaction,tag=interaction.credits_vaynilo,nbt={attack:{}}] on attacker run tellraw @s [{"translate":"credits.msg_shirowh","with":[{"translate":"credits.msg_shirowh.1","color":"dark_aqua",bold:true},{"translate":"credits.msg_shirowh.2","color":"dark_purple", bold: false}]}]
...
execute as @e[type=minecraft:interaction,tag=interaction.credits_vorticepen,nbt={attack:{}}] on attacker run tellraw @s [{"translate":"credits.msg_shirowh","with":[{"translate":"credits.msg_shirowh.1","color":"dark_aqua",bold:true},{"translate":"credits.msg_shirowh.2","color":"dark_purple", bold: false}]}]
