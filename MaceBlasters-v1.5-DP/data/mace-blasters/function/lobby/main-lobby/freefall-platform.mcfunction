...
execute as @a in mace-blasters:mace at @s[tag=lobby_platform_freefall_cloud] run summon armor_stand ~ ~-1 ~ {NoGravity:1b,Invulnerable:0b,Small:1b,Invisible:0b,Tags:["freefall_platform_marker"]}
