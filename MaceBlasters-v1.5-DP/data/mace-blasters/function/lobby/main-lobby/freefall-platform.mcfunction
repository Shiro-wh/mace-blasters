...
execute as @a in mace-blasters:mace at @s[tag=lobby_platform_freefall_cloud] at @e[type=minecraft:armor_stand,tag=freefall_platform_marker] run fill ~-1 ~-2 ~-1 ~1 ~-2 ~1 minecraft:air
...
execute as @a in mace-blasters:mace at @s[tag=lobby_platform_freefall_spark] at @e[type=minecraft:armor_stand,tag=freefall_platform_marker] run fill ~-1 ~-2 ~-1 ~1 ~-2 ~1 minecraft:air
