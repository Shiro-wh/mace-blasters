...
execute as @a in mace-blasters:mace if entity @s[tag=lobby_platform_freefall_spark,x=-104,y=260,z=-109,dx=216,dy=7,dz=225] run effect give @s minecraft:slow_falling 2 1 true
