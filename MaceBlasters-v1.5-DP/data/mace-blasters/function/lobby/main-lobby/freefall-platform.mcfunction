...
execute as @a in mace-blasters:mace if entity @s[tag=lobby.platform_freefall_cloud] run fill ~-1 ~-2 ~-1 ~1 ~-2 ~1 minecraft:cyan_stained_glass
...
execute as @a in mace-blasters:mace if entity @s[tag=lobby.platform_freefall_spark] run fill ~-1 ~-2 ~-1 ~1 ~-2 ~1 minecraft:orange_stained_glass
