...
execute as @a in mace-blasters:mace at @s[tag=lobby_platform_freefall_cloud,distance=..5] run fill ~-1 ~-4 ~-1 ~1 ~-4 ~1 minecraft:cyan_stained_glass
execute as @a in mace-blasters:mace at @s[tag=lobby_platform_freefall_cloud] run summon armor_stand ~ ~-1 ~ {NoGravity:1b,Invulnerable:1b,Small:1b,Invisible:0b,Tags:["freefall_platform_marker"]}
...
execute as @a in mace-blasters:mace at @s[tag=lobby_platform_freefall_spark,distance=..5] run fill ~-1 ~-4 ~-1 ~1 ~-4 ~1 minecraft:orange_stained_glass
execute as @a in mace-blasters:mace at @s[tag=lobby_platform_freefall_spark] run summon armor_stand ~ ~-1 ~ {NoGravity:1b,Invulnerable:1b,Small:1b,Invisible:0b,Tags:["freefall_platform_marker"]}