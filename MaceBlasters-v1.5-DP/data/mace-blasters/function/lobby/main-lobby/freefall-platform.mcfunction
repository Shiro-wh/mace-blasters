...
execute as @a in mace-blasters:mace if entity @s[tag=lobby.platform_freefall_cloud] as @s run fill ~-1 ~-2 ~-1 ~1 ~-2 ~1 minecraft:cyan_stained_glass
...
execute as @a in mace-blasters:mace if entity @s[tag=lobby.platform_freefall_cloud] at @s[x=-104,y=260,z=-109,dx=216,dy=7,dz=225] run effect give @s minecraft:slow_falling 2 1 true
execute as @a in mace-blasters:mace if entity @s[tag=lobby.platform_freefall_cloud] at @e[type=minecraft:armor_stand,tag=freefall.platform_marker] run fill ~-1 ~-2 ~-1 ~1 ~-2 ~1 minecraft:air
...
execute as @a in mace-blasters:mace if entity @s[tag=lobby.platform_freefall_spark] as @s run fill ~-1 ~-2 ~-1 ~1 ~-2 ~1 minecraft:orange_stained_glass
...
execute as @a in mace-blasters:mace if entity @s[tag=lobby.platform_freefall_spark] at @e[type=minecraft:armor_stand,tag=freefall.platform_marker] run fill ~-1 ~-2 ~-1 ~1 ~-2 ~1 minecraft:air
