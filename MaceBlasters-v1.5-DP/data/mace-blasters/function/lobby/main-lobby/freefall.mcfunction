...
execute as @a in mace-blasters:mace if entity @s[tag=lobby_platform_freefall_cloud,x=-104,y=262,z=-109,dx=216,dy=5,dz=225] at @e[type=minecraft:armor_stand,tag=freefall_platform_marker,limit=1] run fill ~-1 ~-5 ~-1 ~1 ~ ~1 minecraft:air replace minecraft:cyan_stained_glass
...
execute as @a in mace-blasters:mace if entity @s[tag=lobby_platform_freefall_spark,x=-104,y=262,z=-109,dx=216,dy=5,dz=225] at @e[type=minecraft:armor_stand,tag=freefall_platform_marker,limit=1] run fill ~-1 ~-5 ~-1 ~1 ~ ~1 minecraft:air replace minecraft:orange_stained_glass
...
execute as @a in mace-blasters:mace if entity @s[tag=lobby_platform_freefall_spark,x=-104,y=262,z=-109,dx=216,dy=5,dz=225] run kill @e[type=minecraft:armor_stand,tag=freefall_platform_marker,limit=1,sort=nearest]
