...
execute as @a in mace-blasters:mace if entity @s[tag=lobby_platform_freefall_cloud,x=-104,y=255,z=-109,dx=216,dy=5,dz=225] run tag @s remove lobby_platform_freefall_cloud
...
execute as @a in mace-blasters:mace if entity @s[tag=lobby_platform_freefall_spark,x=-104,y=255,z=-109,dx=216,dy=5,dz=225] run tag @s remove lobby_platform_freefall_spark
