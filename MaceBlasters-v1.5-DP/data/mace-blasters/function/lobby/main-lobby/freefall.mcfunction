...
execute as @a in mace-blasters:mace at @s[tag=lobby_platform_freefall_cloud,x=-104,y=260,z=-109,dx=216,dy=5,dz=225] run kill @e[type=minecraft:armor_stand,tag=freefall_platform_marker,limit=1,sort=nearest]
...
execute as @a in mace-blasters:mace at @s[tag=lobby_platform_freefall_spark,x=-104,y=260,z=-109,dx=216,dy=5,dz=225] run kill @e[type=minecraft:armor_stand,tag=freefall_platform_marker,limit=1,sort=nearest]
