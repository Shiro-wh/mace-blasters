...
execute if entity @a[x=10,y=216,z=33,distance=..35] run particle minecraft:trial_spawner_detection_ominous 10 262 33 2.1 24 2.1 0.00002 13 force
execute if entity @a[x=-9,y=216,z=33,distance=..35] run particle minecraft:trial_spawner_detection -9 262 33 2.1 24 2.1 0.00002 13 force

execute if entity @a[x=10,y=216,z=33,distance=36..60] run particle minecraft:trial_spawner_detection_ominous 10 262 33 2.1 12 2.1 0.00002 9 force
execute if entity @a[x=-9,y=216,z=33,distance=36..60] run particle minecraft:trial_spawner_detection -9 262 33 2.1 12 2.1 0.00002 9 force

execute if entity @a[x=10,y=216,z=33,distance=61..85] run particle minecraft:trial_spawner_detection_ominous 10 262 33 2.1 6 2.1 0.00002 5 force
execute if entity @a[x=-9,y=216,z=33,distance=61..85] run particle minecraft:trial_spawner_detection -9 262 33 2.1 6 2.1 0.00002 5 force
