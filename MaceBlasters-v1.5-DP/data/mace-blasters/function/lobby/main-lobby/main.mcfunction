...
execute if entity @a[x=-9,y=216,z=33,distance=51..75] run particle minecraft:trial_spawner_detection -9 262 33 2.1 24 2.1 0.00002 7 force
...
execute if entity @a[x=-9,y=216,z=33,distance=76..95] run particle minecraft:trial_spawner_detection -9 262 33 2.1 24 2.1 0.00002 3.5 force
